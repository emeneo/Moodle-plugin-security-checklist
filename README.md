...
| 013| Do not include third party library code in your plugin package which ist already provided by moodle (e.g jQuery) |  |⬜|
| 014| Keep included third party libraries up to date|  |⬜|
| 015| Never put any passwords etc. into the code|  |⬜|
